...
from liquidation_engine import snapshot as liquidation_snapshot, apply_to_forward as apply_liquidation_to_forward
...
def analyze():
    ...
    try:
        ...
        liq_ctx={"available":False,"provider":"Недоступно","source_mode":"none","bias":"NEUTRAL","dominance":0.0,"forecast_adjustment_1h_pp":0.0,"levels_used":0,"note":f"Ошибка liquidation engine: {type(e).__name__}"}
